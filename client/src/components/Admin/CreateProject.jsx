// working correctly but two close buttons and no project id
    ...
    <div className="container mx-auto mt-8">
      ...
      >
        ...
        <div className="mb-4">
          ...
          {/* Display autocomplete suggestions */}
          {searchTerm && (
            <div className="bg-white border border-gray-300 mt-2 rounded shadow-md">
        ...
        {/* Display selected team members */}
        <div className="mb-4">
          <h3 className="text-lg font-bold mb-2">Selected Team Members</h3>
